<template>
  <div class="view">
    ...
    <h4>■このサイトの目的</h4>
    <ol>
      <li>アダルト、一般施設問わず、<a href="https://www.secondlife.com/?lang=ja">セカンドライフ</a>内の日本人がいる施設やイベントのリンク集です</li>
      <li>施設オーナーはセンサを置くだけで利用できます(申請不要)</li>
      <li>イベントのSLT⇨JST日本時間変換/計算は<a href="/">TOPページ</a>でできます</li>
    </ol>
    ...
    <table class="table table-striped">
      ...
      <tr>
        ...
        <td>すみません、センサのバグか不具合でサーバと同期が取れていない可能性があります。新しいセンサと置き換えてください。</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td>
          ...
          設置者が異なる場合は古いセンサを撤去して72時間後(施設情報がWebから消えた後)に、設置してください。<br>
          急ぎの場合はutenにIMください。
        </td>
      </tr>
      <tr>
